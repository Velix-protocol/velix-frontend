            ...
            <div className="z-20">
              ...
              <div className="flex gap-3 lg:gap-5 mt-5 max-lg:flex-col">
                <Button className="font-space-grotesk text-velix-black  px-10 py-6 bg-white hover:bg-white">
                  <a href="https://discord.gg/v594pjBw5u" target="_blank" aria-label="Join the Discord community">
                    Join the discord
                  </a>
                </Button>
                <Button
                ...
                >
                  <a href="https://t.me/velixprotocol" target="_blank" aria-label="Join Telegram">
                    Join Telegram
                  </a>
                </Button>
              </div>
