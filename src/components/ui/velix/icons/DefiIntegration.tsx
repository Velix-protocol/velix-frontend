...
interface VelixDefiIconProps extends React.SVGProps<SVGSVGElement> {}

const VelixDefiIcon: React.FC<VelixDefiIconProps> = ({ className, ...props }) => (
  <svg
    className={className} 
    width="498"
    height="405"
    ...
    {...props} 
  >
    <g clipPath="url(#clip0_2810_8120)">
      <path
