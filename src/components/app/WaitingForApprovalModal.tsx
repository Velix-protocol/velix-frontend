...
export default function WaitingModal({
  ...
  return (
    <div className="fixed z-[999] px-8 bg-velix-blue/20 dark:bg-black/50 inset-0 font-space-grotesk">
      <div className="bg-white dark:bg-velix-primary max-w-screen-sm mx-auto flex justify-center items-center mt-40 relative p-10 lg:p-20 rounded-lg">
