            ...
            <div className="lg:flex md:flex sm:flex-row gap-4 items-start">
              ...
              <div className="flex lg:flex-col md:flex-col sm:flex-row justify-start mt-20 lg:w-1/3 gap-4">
                <div className="bg-velix-claim-gray3 p-2 rounded-lg w-fit h-fit flex items-start">
                  <StepsSpan number={1} className="lg:ml-12 ml-[-1rem] mt-[-1rem] lg:mt-[-1.4rem] font-normal" />
                ...
                <DescTitle
                  ...
                  description={
                    <>
                      Mint/stake tokens on your<br />
                      preferred chain
                    </>
                  }
                />
              </div>
              <img src="/svg/ArrowSteps1.svg" alt="Receive arrow" className="mt-[7.5rem] w-auto h-auto -ml-[20.5rem] lg:block hidden" />
              <img src="/svg/ArrowSteps.svg" alt="steps arrow" className="ml-8 sm:block lg:hidden md:hidden"/>
              <img src="/svg/ArrowMeduim.svg" alt="Meduim arrow" className="ml-[-6rem] mt-[7rem] md:block lg:hidden w-[8rem] hidden"/>
              ...
              <div className="flex lg:flex-col md:flex-col sm:flex-row lg:mt-[15rem] md:mt-20 mb-5 gap-4">
                <div className="bg-velix-claim-gray2 lg:-ml-4 md:-ml-4 p-2 rounded-lg w-fit h-fit flex items-start">
                  <StepsSpan number={2} className="lg:ml-12 ml-[-1rem] mr-[4rem] mt-[-1rem] lg:mt-[-1.3rem]" />
              ...
              <img src="/svg/receive-arrow.svg" alt="Receive arrow" className="mt-[7.5rem] w-auto h-auto -ml-[8.4rem] lg:block hidden" />
              <img src="/svg/ArrowSteps.svg" alt="steps arrow" className="ml-8 sm:block lg:hidden mt-[-1.2rem] md:hidden"/>
              <img src="/svg/ArrowMeduim.svg" alt="Meduim arrow" className="ml-[-5.4rem] mt-[7rem] md:block lg:hidden w-[8rem] hidden"/>


              <div className="flex lg:flex-col md:flex-col sm:flex-row items-center lg:mt-20 md:mt-20 md:ml-[-1rem] lg:ml-[-1.6rem]">
                <StepsSpan number={3} className="lg:ml-[13rem] ml-[-0.3rem] md:ml-[-18rem] md:mt-[-0.6rem] lg:mt-[-0.8rem] mb-[13.5rem]" />
